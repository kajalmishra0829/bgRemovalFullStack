...
const BgSlider = () => {
    ...
    return (
        <div className='pb-10 md:py-20 mx-7'>
            {/* title */}
            <h1 className='mb-12 sm:mb-20 text-center text-2xl md:text-3xl lg:text-4xl mt-4 pb-1 font-semibold bg-linear-to-r from-gray-900 to-gray-400 bg-clip-text text-transparent'>Remove Background with High <br /> Quality and Accuracy</h1>
            <div className='relative w-full max-w-3xl overflow-hidden m-auto rounded-xl'>
                {/* syntax for clip -> clip-path: inset(top right bottom left); */}
